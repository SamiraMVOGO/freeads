...
@section('content')
      @if ($message = Session::get('success'))
                    <div class="text-green-700 text-center mb-4">
                        {{ $message }}
                    </div>     
                @endif
...
<div class="w-[65%] mx-auto">
 <div class="text-xl mb-[8%]">Log in to have the ability to add an <span class="text-colororange">unlimited</span> number of ads</div>
   ...
   @if ($errors->has('email'))
    ...
    <div class="flex flex-wrap justify-between">
        ...
        <div class="cursor-pointer  underline">
            <a href="{{ route('forgot.password.link') }}">
                 Forgot password?
            </a>
    ...
    <div class="mt-[7%]">
        <button type="submit" class="bg-colororange hover:shadow-2xl text-white rounded-full lg:w-[25%] md:w-[30%] w-[60%] mb-4 cursor-pointer h-auto p-3 text-center font-medium">Sign In</button>
    </div>
    </form>
