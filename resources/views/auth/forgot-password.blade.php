...
<div>
   ...
   <div class="text-xl mb-[8%]">Enter your new login information</div>
    <div class="flex flex-col gap-1 mb-4">
       ...
       <div>
    <input class="border-b border-gray-400 p-2  rounded-lg opacity-50 focus:opacity-100  w-full focus:border-black focus:outline-hidden" type="email" id="email" name="email" placeholder="Your email goes here" value="{{ old('email')}}" >
   @if ($errors->has('email'))
       ...
       <div class="flex flex-col gap-1 mb-4">
        ...
        <div class="relative">
            <input class="border-b border-gray-400 p-2 rounded-lg opacity-50 focus:opacity-100  w-full focus:border-black focus:outline-hidden" type="password" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation')}}" autofocus>
    ...
    <div class="mt-[7%]">
        <button type="submit" class="bg-colororange text-white rounded-full lg:w-[25%] md:w-[30%] w-[60%] mb-4 cursor-pointer h-auto p-3 text-center font-medium">Submit</button>
    </div>
</form>
</div>
   @endsection 
